...
public class Editor {
	...
	private void initialize() {
		...
		frame = new JFrame();
		frame.setBounds(100, 100, 987, 696);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(new MigLayout("", "[grow][grow 50]", "[][grow]"));
		...
		frame.getContentPane().add(scrlTable, "cell 1 1,grow");
	...
	protected void highlightLine(int line, Color colour)
	{
		...
		doc.setCharacterAttributes(start - breaks, end - start - 1, highlightStyle, false);
	}
